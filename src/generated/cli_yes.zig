// cli_yes.zig — GENERATED by src/tools/fx-clijson.zig from schemas/yes.dhall.
...
pub fn parsePosix(args: []const []const u8, gpa: Allocator) ParseError!Options {
    ...
    while (i < args.len) : (i += 1) {
        ...
        if (a.len > 1 and a[0] == '-') {
            std.debug.print("fx-yes: unknown option '{s}'\n", .{ a });
