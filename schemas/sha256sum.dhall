...
--   posix fx-sha256sum.zig:225-242 parsePosixArgs:
...
in
{ doc = Some "print or check SHA-256 checksums"
, ty =
    { files : List Text
    , binary : Bool
    }
